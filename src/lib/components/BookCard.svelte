...
<div class="tooltip tooltip-bottom" data-tip={book.description}>
  <div
    class={`card card-side bg-base-100 shadow-xl w-96 max-w-96 group hover:scale-110 transition-all duration-300 hover:shadow-2xl ${book.read ? "border-2 border-green-500" : ""}`}
    on:click={handleClick}
  >
    <figure>
      <img src={book.cover} alt="Book Cover" class="h-64 w-48 object-cover" />
    </figure>
    <div
